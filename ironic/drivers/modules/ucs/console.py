...
from ironic.drivers.modules.ipmitool import IPMIShellinaboxConsole, _parse_driver_info, _console_pwfile_path
...
class UcsShellInaboxConsole(IPMIShellinaboxConsole):
    def start_console(self, task):
        ...
        try:
            console_utils.start_shellinabox_console(driver_info['uuid'], driver_info['port'], cmd)
